...
public class StatusView extends View {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.StatusView, defStyle, 0);

        if (a != null) {
            portionColor = a.getColor(R.styleable.StatusView_portion_color, DEFAULT_COLOR);
            portionWidth = a.getDimensionPixelSize(R.styleable.StatusView_portion_width, (int) DEFAULT_PORTION_WIDTH);
            portionSpacing = a.getDimensionPixelSize(R.styleable.StatusView_portion_spacing, DEFAULT_PORTION_SPACING);
            portionsCount = a.getInteger(R.styleable.StatusView_portions_count, (int) DEFAULT_PORTIONS_COUNT);
